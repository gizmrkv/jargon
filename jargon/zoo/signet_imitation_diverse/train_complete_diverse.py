...
def train_complete_diverse(
    ...
    poor_sender_input_embedding_dim: int | None = None,
    poor_sender_output_embedding_dim: int | None = None,
    ...
    good_sender_input_embedding_dim: int | None = None,
    good_sender_output_embedding_dim: int | None = None,
